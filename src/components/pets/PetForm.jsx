  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 bg-gray-50 dark:bg-secondary-dark p-6 rounded-lg">
      ...
      <div className="flex justify-end space-x-3 pt-4">
        ...
        <button type="submit" className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 disabled:opacity-50" disabled={uploading}>{uploading ? 'Adding Pet...' : 'Add Pet'}</button>
      </div>
    </form>
  );
};
